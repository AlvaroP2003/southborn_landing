        ...
        <section id="about" className="flex flex-col lg:flex-row lg:justify-between py-50 px-5 lg:px-50 lg:h-[70vh]">
            ...
            <h1 className="text-white text-4xl lg:text-6xl lg:flex-1 mb-4 lg:mb-0">WHERE GYM MEETS THE STREET</h1>
                ...
                <div className="relative w-full lg:flex-1">
                    <p className="text-sm lg:text-base text-neutral-400">Southborn is a Cape Town-born gym and streetwear brand for people who don't separate training from style. We make compression shirts and performance apparel designed to move with you — built for the gym floor, made for the street.
